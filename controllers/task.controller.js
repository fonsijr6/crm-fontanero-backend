...
exports.create = async (req, res) => {
  try {
    ...
    if (!clientName || typeof clientName !== 'string')
      errors.push('clientName is required and must be string');
    if (!address || typeof address !== 'string')
      errors.push('Address is required and must be string');
    if (!description || typeof description !== 'string')
      errors.push('Description is required and must be string');
    if (!date || typeof date !== 'string')
      errors.push('Date is required and must be string');
    if (!time || typeof time !== 'string')
      errors.push('Time is required and must be string');
    ...
    if (images !== undefined) {
      ...
      if (!images.every((i) => typeof i === 'string'))
    ...
    const payload = {
      ...
      time,
      status,
      images: images || [], // ✅ por defecto vacío
    };
...
exports.update = async (req, res) => {
  try {
    ...
    if (date !== undefined && typeof date !== 'string')
      errors.push('date must be string');
    if (time !== undefined && typeof time !== 'string')
      errors.push('time must be string');
    if (
      status !== undefined &&
    ...
    // ✅ Validación opcional de imágenes
    if (images !== undefined) {
      if (!Array.isArray(images)) errors.push('images must be array');
      if (!images.every((i) => typeof i === 'string'))
        errors.push('each image must be a URL string');
    }
    ...
    const payload = {
      ...
      ...(images !== undefined && { images }), // ✅ permite cambiar imágenes
    };
